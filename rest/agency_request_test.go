...
func TestAgencyRequest(t *testing.T) {
	...
	testcases := []testRest{
		{"basic", AgencyRequest{}, "", "agencies.#.agency_id", []string{"caltrain-ca-us", "BART", "HART"}, 0},
		...
		{"adm0name", AgencyRequest{Adm0Name: "united states of america"}, "", "agencies.#.agency_id", []string{"caltrain-ca-us", "BART", "HART"}, 0},
		{"adm1name", AgencyRequest{Adm1Name: "california"}, "", "agencies.#.agency_id", []string{"caltrain-ca-us", "BART"}, 0},
		{"adm0iso", AgencyRequest{Adm0Iso: "us"}, "", "agencies.#.agency_id", []string{"caltrain-ca-us", "BART", "HART"}, 0},
