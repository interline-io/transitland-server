...
func TestOperatorRequest(t *testing.T) {
	cfg := testRestConfig()
	testcases := []testRest{
		{"basic", OperatorRequest{}, "", "operators.#.onestop_id", []string{"o-9q9-caltrain", "o-9q9-bayarearapidtransit", "o-dhv-hillsborougharearegionaltransit"}, 0},
		...
		{"adm0name", OperatorRequest{Adm0Name: "united states of america"}, "", "operators.#.onestop_id", []string{"o-9q9-caltrain", "o-9q9-bayarearapidtransit", "o-dhv-hillsborougharearegionaltransit"}, 0},
		{"adm1name", OperatorRequest{Adm1Name: "california"}, "", "operators.#.onestop_id", []string{"o-9q9-caltrain", "o-9q9-bayarearapidtransit"}, 0},
		{"adm0iso", OperatorRequest{Adm0Iso: "us"}, "", "operators.#.onestop_id", []string{"o-9q9-caltrain", "o-9q9-bayarearapidtransit", "o-dhv-hillsborougharearegionaltransit"}, 0},
