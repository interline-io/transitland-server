...
func TestOperatorRequest_Pagination(t *testing.T) {
	testcases := []testRest{
		{
			name:         "limit:1",
			h:            OperatorRequest{Limit: 1},
			selector:     "operators.#.onestop_id",
			expectLength: 1,
		},
		{
			name:         "limit:1000",
			h:            OperatorRequest{Limit: 1000},
			selector:     "operators.#.onestop_id",
			expectLength: 4,
		},
	}
	...
	testcases := []testRest{
		{
			...
			h:            OperatorRequest{Limit: 10_000, LicenseFilter: LicenseFilter{LicenseShareAlikeOptional: "yes"}},
			selector:     "operators.#.onestop_id",
			expectSelect: []string{"o-dhv-hillsborougharearegionaltransit"},
		},
		{
			name:         "license:share_alike_optional no",
			h:            OperatorRequest{Limit: 10_000, LicenseFilter: LicenseFilter{LicenseShareAlikeOptional: "no"}},
			selector:     "operators.#.onestop_id",
			expectSelect: []string{"o-9q9-bayarearapidtransit"},
		},
		{
			name:         "license:share_alike_optional exclude_no",
			h:            OperatorRequest{Limit: 10_000, LicenseFilter: LicenseFilter{LicenseShareAlikeOptional: "exclude_no"}},
			selector:     "operators.#.onestop_id",
		...
		},
		{
			...
			h:            OperatorRequest{Limit: 10_000, LicenseFilter: LicenseFilter{LicenseCommercialUseAllowed: "yes"}},
			selector:     "operators.#.onestop_id",
			expectSelect: []string{"o-dhv-hillsborougharearegionaltransit"},
		},
		{
			name:         "license:commercial_use_allowed no",
			h:            OperatorRequest{Limit: 10_000, LicenseFilter: LicenseFilter{LicenseCommercialUseAllowed: "no"}},
			selector:     "operators.#.onestop_id",
			expectSelect: []string{"o-9q9-bayarearapidtransit"},
		},
		{
			name:         "license:commercial_use_allowed exclude_no",
			h:            OperatorRequest{Limit: 10_000, LicenseFilter: LicenseFilter{LicenseCommercialUseAllowed: "exclude_no"}},
			selector:     "operators.#.onestop_id",
			expectSelect: []string{"o-9q9-caltrain", "o-dhv-hillsborougharearegionaltransit", "o-9qs-demotransitauthority"},
		},
		{
			name:         "license:create_derived_product yes",
			h:            OperatorRequest{Limit: 10_000, LicenseFilter: LicenseFilter{LicenseCreateDerivedProduct: "yes"}},
			selector:     "operators.#.onestop_id",
			expectSelect: []string{"o-dhv-hillsborougharearegionaltransit"},
		},
		{
			name:         "license:create_derived_product no",
			h:            OperatorRequest{Limit: 10_000, LicenseFilter: LicenseFilter{LicenseCreateDerivedProduct: "no"}},
			selector:     "operators.#.onestop_id",
			expectSelect: []string{"o-9q9-bayarearapidtransit"},
		},
		{
			name:         "license:create_derived_product exclude_no",
			h:            OperatorRequest{Limit: 10_000, LicenseFilter: LicenseFilter{LicenseCreateDerivedProduct: "exclude_no"}},
			selector:     "operators.#.onestop_id",
			expectSelect: []string{"o-9q9-caltrain", "o-dhv-hillsborougharearegionaltransit", "o-9qs-demotransitauthority"},
		},
	}
