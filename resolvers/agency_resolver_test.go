...
func TestAgencyResolver(t *testing.T) {
	...
	testcases := []testcase{
		...
		// places should test filters because it's not a root resolver
		{
			...
			expectSelect: []string{"San Mateo", "San Francisco", "San Jose", ""},
		},
		{
			...
			expect:       ``,
			selector:     "agencies.0.places.#.city_name",
			expectSelect: []string{"San Mateo", "San Jose", ""},
		},
		{
		...
		// place iso codes
		{
			...
			expectSelect: []string{"o-9q9-bayarearapidtransit", "o-9q9-caltrain", "o-dhv-hillsborougharearegionaltransit"},
		},
		{
			...
			expect:       ``,
			selector:     "agencies.#.onestop_id",
			expectSelect: []string{"o-9q9-bayarearapidtransit", "o-9q9-caltrain"},
		},
		{
