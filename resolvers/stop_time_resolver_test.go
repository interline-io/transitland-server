	...
	testcases := []testcase{
		{
			...
			expectSelect: []string{"05:26:00", "05:29:00", "05:33:00", "05:36:00", "05:40:00", "05:43:00", "05:46:00", "05:48:00", "05:50:00", "05:53:00", "05:54:00", "05:56:00", "05:58:00", "06:05:00", "06:08:00", "06:11:00", "06:15:00", "06:17:00", "06:23:00", "06:27:00", "06:32:00", "06:35:00", "06:40:00", "06:43:00", "06:50:00", "07:05:00", "07:13:00"},
		},
		{
		...
		},
		{
			...
			expectSelect: []string{"SFIA", "SBRN", "SSAN", "COLM", "DALY", "BALB", "GLEN", "24TH", "16TH", "CIVC", "POWL", "MONT", "EMBR", "WOAK", "12TH", "19TH_N", "MCAR", "ROCK", "ORIN", "LAFY", "WCRK", "PHIL", "CONC", "NCON", "PITT", "PCTR", "ANTC"},
		},
		{
		...
		// check StopTimeFilter through a stop
		{
			...
			expectSelect: []string{"07:18:00", "07:24:00", "07:28:00", "07:33:00", "07:39:00", "07:43:00", "07:48:00", "07:54:00", "07:58:00", "08:03:00", "08:09:00", "08:18:00", "07:24:00", "07:39:00", "07:54:00", "08:09:00", "07:16:00", "07:31:00", "07:46:00", "08:01:00", "08:16:00"},
		},
		{
			...
			expect:       ``,
			selector:     "stops.0.stop_times.#.arrival_time",
			expectSelect: []string{"04:39:00", "04:54:00", "05:09:00", "05:24:00", "04:39:00", "04:54:00", "05:09:00", "05:24:00", "04:31:00", "04:46:00", "05:01:00", "05:16:00", "05:31:00"},
		},
		{
			...
			expect:       ``,
			selector:     "stops.0.stop_times.#.arrival_time",
			expectSelect: []string{"21:14:00", "21:34:00", "21:54:00", "22:14:00", "22:34:00", "22:54:00", "23:14:00", "23:34:00", "23:54:00", "24:14:00", "24:47:00", "21:14:00", "21:34:00", "21:54:00", "22:14:00", "22:34:00", "22:54:00", "23:14:00", "23:34:00", "23:54:00", "24:14:00", "24:47:00"},
		},
		// accept strings for Start / End
		{
			...
			expectSelect: []string{"10:02:00", "10:05:00", "10:10:00"},
		},
		...
		// check arrival and departure resolvers
		{
			...
			expect:       ``,
			selector:     "stops.0.stop_times.#.departure_time",
			expectSelect: []string{"21:09:00", "21:14:00", "21:15:00"},
		},
		{
			name:         "departures",
		...
		},
		{
			...
			expectSelect: []string{"21:09:00", "21:14:00"},
		},
		// route_onestop_ids
		{
			...
			expect:       ``,
			selector:     "stops.0.departures.#.departure_time",
			expectSelect: []string{"10:05:00", "10:12:00", "10:20:00", "10:27:00", "10:35:00", "10:42:00", "10:50:00", "10:57:00"},
		},
		{
			...
			expect:       ``,
			selector:     "stops.0.departures.#.departure_time",
			expectSelect: []string{"10:12:00", "10:27:00", "10:42:00", "10:57:00"},
		},
		{
			...
			expect:       ``,
			selector:     "stops.0.departures.#.departure_time",
			expectSelect: []string{"10:05:00", "10:20:00", "10:35:00", "10:50:00"},
		},
	...
	testcases := []testcase{
		{
			...
			expectSelect: []string{"2018-05-29"}, // expect input date
		},
		{
			...
			expect:       ``,
			selector:     "stops.0.stop_times.0.service_date",
			expectSelect: []string{"2018-06-05"}, // expect adjusted date in window
		},
		{
			...
			expect:       ``,
			selector:     "stops.0.stop_times.0.service_date",
			expectSelect: []string{"2018-06-08"}, // expect adjusted date in window
		},
		{
			...
			expectSelect: []string{}, // exect no results
		},
	}
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
...
func TestStopResolver_StopTimes_WindowDates(t *testing.T) {
	...
	testcases := []testcase{
		...
		},
		{
			...
			expect:       ``,
			selector:     "stops.0.stop_times.#.arrival_time",
			expectSelect: []string{"15:48:00", "15:50:00"},
		},
		{
	...
	testcases := []tcWithClock{
		// Relative times
		{
			testcase{
				...
				expect:       ``,
				selector:     "stops.0.stop_times.#.arrival_time",
				expectSelect: []string{"15:01:00", "15:09:00", "15:09:00", "15:16:00", "15:24:00", "15:24:00", "15:31:00", "15:39:00", "15:39:00", "15:46:00", "15:54:00", "15:54:00"}, // these should start at 15:00 - 16:00
		...
		},
		{
			testcase{
				...
				expect:       ``,
				selector:     "stops.0.stop_times.#.arrival_time",
				expectSelect: []string{"15:01:00", "15:09:00", "15:09:00", "15:16:00", "15:24:00", "15:24:00"}, // these should start at 15:00 - 15:30
		...
		},
		{
			testcase{
				...
				expect:       ``,
				selector:     "stops.0.stop_times.#.arrival_time",
				expectSelect: []string{"18:00:00", "18:00:00", "18:00:00", "18:00:00", "18:00:00", "18:03:00", "18:10:00", "18:10:00", "18:13:00", "18:14:00", "18:15:00", "18:15:00"}, // these should start at 18:00 - 18:15
