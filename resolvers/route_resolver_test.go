	...
	testcases := []testcase{
		{
			...
			expectSelect: []string{"1", "12", "14", "15", "16", "17", "19", "20", "24", "25", "275", "30", "31", "32", "33", "34", "35", "36", "360", "37", "38", "39", "400", "42", "45", "46", "48", "5", "51", "6", "60", "7", "75", "8", "9", "96", "97", "570", "571", "572", "573", "574", "800", "PWT", "SKY", "01", "03", "05", "07", "11", "19", "Bu-130", "Li-130", "Lo-130", "TaSj-130", "Gi-130", "Sp-130"},
		},
		{
			name:         "basic fields",
		...
		},
		{
			...
			expectSelect: []string{"MultiLineString"},
		},
		{
			name:         "feed_version",
		...
		},
		{
			...
			expectSelect: []string{"305", "309", "313", "319", "323", "329", "365", "371", "375", "381", "385", "310", "314", "320", "324", "330", "360", "366", "370", "376", "380", "386", "801", "803", "802", "804"},
		},
		{
			name:         "route_stops",
			...
			expectSelect: []string{"12TH", "19TH", "19TH_N", "ASHB", "BAYF", "COLS", "DBRK", "DELN", "PLZA", "FRMT", "FTVL", "HAYW", "LAKE", "MCAR", "MCAR_S", "NBRK", "RICH", "SANL", "SHAY", "UCTY", "WARM"},
		},
		{
		...
		},
		{
			...
			expectSelect: []string{"MultiPoint"},
		},
		{
			...
			expectSelect: []string{"MultiPolygon"},
		},
		{
		...
		},
		{
			...
			expectSelect: []string{"1", "6", "7", "1", "6", "7"}, // now includes one for each direction and dow category
		},
		{
		...
		// route patterns
		{
			...
			expectSelect: []string{"132", "124", "56", "50", "2"},
		},
		// license
		{
		...
		},
		{
			...
			expectSelect: []string{"yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes"}, // 51 routes
		},
		{
	...
	testcases := []testcase{
		{
			...
			expectSelect: []string{"r-9q9-antioch~sfia~millbrae"},
		},
		{
		...
		},
		{
			...
			expect:       ``,
			selector:     "routes.#.onestop_id",
			expectSelect: []string{"r-9q9-pittsburg~baypoint~sfia~millbrae"},
		},
		{
			name:         "use previous",
			query:        `query($osid:String!, $previous:Boolean!) { routes(where:{onestop_id:$osid, allow_previous_onestop_ids:$previous}) { route_id onestop_id }}`,
