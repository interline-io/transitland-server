...
func TestFeedRequest(t *testing.T) {
	...
	testcases := []testCase{
		...
		{
			name:         "url source",
			h:            &FeedRequest{URL: "file://testdata/server/gtfs/caltrain.zip"},
			format:       "",
			selector:     "feeds.#.onestop_id",
		...
		},
		{
			...
			h:            &FeedRequest{URL: "file://testdata/server/gtfs/caltrain.zip", URLType: "static_current"},
			format:       "",
			selector:     "feeds.#.onestop_id",
			expectSelect: []string{"CT"},
		},
		{
			...
			h:            &FeedRequest{URL: "file://testdata/server/gtfs/Caltrain.zip", URLCaseSensitive: false},
			format:       "",
			selector:     "feeds.#.onestop_id",
			expectSelect: []string{"CT"},
		},
		{
			...
			h:            &FeedRequest{URL: "file://testdata/server/gtfs/Caltrain.zip", URLCaseSensitive: true},
			format:       "",
			selector:     "feeds.#.onestop_id",
			expectSelect: []string{},
		},
