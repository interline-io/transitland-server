...
func (r *validationReportResolver) Errors(ctx context.Context, obj *model.ValidationReport, limit *int) ([]*model.ValidationReportErrorGroup, error) {
	...
	return LoaderFor(ctx).ValidationReportErrorGroupsByValidationReportIDs.Load(ctx, ValidationReportErrorGroupParam{ValidationReportID: obj.ID, Limit: limit})()
}
...
func (r *validationReportErrorGroupResolver) Errors(ctx context.Context, obj *model.ValidationReportErrorGroup, limit *int) ([]*model.ValidationReportError, error) {
	...
	ret, err := LoaderFor(ctx).ValidationReportErrorExemplarsByValidationReportErrorGroupIDs.Load(ctx, ValidationReportErrorExemplarParam{ValidationReportGroupID: obj.ID, Limit: limit})()
	if err != nil {
		return nil, err
	}
	for _, r := range ret {
