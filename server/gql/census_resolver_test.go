...
func TestCensusResolver(t *testing.T) {
	...
	testcases := []testcase{
		...
		},
		{
			...
			query:        `query { census_datasets(where:{dataset_name:"tiger2024"}) {dataset_name geographies(where:{layer: "tract", near: {lon:-122.270, lat:37.805, radius:1000}}) { name geoid }} }`,
			vars:         vars,
			selector:     "census_datasets.0.geographies.#.geoid",
		...
		},
		{
			...
			query:        `query { census_datasets(where:{dataset_name:"tiger2024"}) {dataset_name geographies(where:{layer: "tract", near: {lon:-122.270, lat:37.805, radius:100}}) { name geoid }} }`,
			vars:         vars,
			selector:     "census_datasets.0.geographies.#.geoid",
		...
		},
		{
			...
			query:        `query { census_datasets(where:{dataset_name:"tiger2024"}) {dataset_name geographies(where:{layer: "tract", near: {lon:-122.270, lat:37.805, radius:10}}) { name geoid }} }`,
			vars:         vars,
			selector:     "census_datasets.0.geographies.#.geoid",
		...
		},
		{
			...
			query:        `query { census_datasets(where:{dataset_name:"tiger2024"}) {dataset_name geographies(where:{layer: "county", near: {lon:-122.270, lat:37.805, radius:1000}}) { name geoid }} }`,
			vars:         vars,
			selector:     "census_datasets.0.geographies.#.geoid",
		...
		},
		{
			...
			query:        `query($bbox:BoundingBox) { census_datasets(where:{dataset_name:"tiger2024"}) {dataset_name geographies(where:{layer: "tract", bbox:$bbox}) { name geoid }} }`,
