...
var file_azpb_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x22, 0x87, 0x01, 0x0a, 0x0a, 0x4d, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x78, 0x70, 0x61, 0x6e, 0x64, 0x65, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x22, 0x2c, 0x0a,
...
var file_azpb_proto_depIdxs = []int32{
	...
	11, // 8: azpb.TenantSaveRequest.tenant:type_name -> azpb.Tenant
	11, // 9: azpb.TenantResponse.tenant:type_name -> azpb.Tenant
	11, // 10: azpb.TenantListResponse.tenants:type_name -> azpb.Tenant
	11, // 11: azpb.TenantPermissionsResponse.tenant:type_name -> azpb.Tenant
	23, // 12: azpb.TenantPermissionsResponse.groups:type_name -> azpb.Group
	50, // 13: azpb.TenantPermissionsResponse.actions:type_name -> azpb.TenantPermissionsResponse.Actions
	51, // 14: azpb.TenantPermissionsResponse.users:type_name -> azpb.TenantPermissionsResponse.Users
	23, // 15: azpb.TenantCreateGroupRequest.group:type_name -> azpb.Group
	23, // 16: azpb.TenantCreateGroupResponse.group:type_name -> azpb.Group
	3,  // 17: azpb.TenantModifyPermissionRequest.entity_relation:type_name -> azpb.EntityRelation
	23, // 18: azpb.GroupSaveRequest.group:type_name -> azpb.Group
	3,  // 19: azpb.GroupModifyPermissionRequest.entity_relation:type_name -> azpb.EntityRelation
	23, // 20: azpb.GroupResponse.group:type_name -> azpb.Group
	23, // 21: azpb.GroupListResponse.groups:type_name -> azpb.Group
	23, // 22: azpb.GroupPermissionsResponse.group:type_name -> azpb.Group
	11, // 23: azpb.GroupPermissionsResponse.tenant:type_name -> azpb.Tenant
	34, // 24: azpb.GroupPermissionsResponse.feeds:type_name -> azpb.Feed
	52, // 25: azpb.GroupPermissionsResponse.actions:type_name -> azpb.GroupPermissionsResponse.Actions
	53, // 26: azpb.GroupPermissionsResponse.users:type_name -> azpb.GroupPermissionsResponse.Users
	23, // 27: azpb.GroupSaveResponse.group:type_name -> azpb.Group
	34, // 28: azpb.FeedPermissionsResponse.feed:type_name -> azpb.Feed
	23, // 29: azpb.FeedPermissionsResponse.group:type_name -> azpb.Group
	54, // 30: azpb.FeedPermissionsResponse.actions:type_name -> azpb.FeedPermissionsResponse.Actions
	34, // 31: azpb.FeedResponse.feed:type_name -> azpb.Feed
	34, // 32: azpb.FeedListResponse.feeds:type_name -> azpb.Feed
	42, // 33: azpb.FeedVersionResponse.feed_version:type_name -> azpb.FeedVersion
	42, // 34: azpb.FeedVersionListResponse.feed_versions:type_name -> azpb.FeedVersion
	42, // 35: azpb.FeedVersionPermissionsResponse.feed_version:type_name -> azpb.FeedVersion
	34, // 36: azpb.FeedVersionPermissionsResponse.feed:type_name -> azpb.Feed
	23, // 37: azpb.FeedVersionPermissionsResponse.group:type_name -> azpb.Group
	55, // 38: azpb.FeedVersionPermissionsResponse.actions:type_name -> azpb.FeedVersionPermissionsResponse.Actions
	56, // 39: azpb.FeedVersionPermissionsResponse.users:type_name -> azpb.FeedVersionPermissionsResponse.Users
	3,  // 40: azpb.FeedVersionModifyPermissionRequest.entity_relation:type_name -> azpb.EntityRelation
	3,  // 41: azpb.TenantPermissionsResponse.Users.admins:type_name -> azpb.EntityRelation
	3,  // 42: azpb.TenantPermissionsResponse.Users.members:type_name -> azpb.EntityRelation
	3,  // 43: azpb.GroupPermissionsResponse.Users.managers:type_name -> azpb.EntityRelation
	3,  // 44: azpb.GroupPermissionsResponse.Users.editors:type_name -> azpb.EntityRelation
	3,  // 45: azpb.GroupPermissionsResponse.Users.viewers:type_name -> azpb.EntityRelation
	3,  // 46: azpb.FeedVersionPermissionsResponse.Users.editors:type_name -> azpb.EntityRelation
	3,  // 47: azpb.FeedVersionPermissionsResponse.Users.viewers:type_name -> azpb.EntityRelation
	5,  // 48: azpb.Checker.UserList:input_type -> azpb.UserListRequest
	6,  // 49: azpb.Checker.User:input_type -> azpb.UserRequest
	9,  // 50: azpb.Checker.Me:input_type -> azpb.MeRequest
	14, // 51: azpb.Checker.TenantList:input_type -> azpb.TenantListRequest
	13, // 52: azpb.Checker.Tenant:input_type -> azpb.TenantRequest
	13, // 53: azpb.Checker.TenantPermissions:input_type -> azpb.TenantRequest
	12, // 54: azpb.Checker.TenantSave:input_type -> azpb.TenantSaveRequest
	21, // 55: azpb.Checker.TenantAddPermission:input_type -> azpb.TenantModifyPermissionRequest
	21, // 56: azpb.Checker.TenantRemovePermission:input_type -> azpb.TenantModifyPermissionRequest
	18, // 57: azpb.Checker.TenantCreate:input_type -> azpb.TenantCreateRequest
	19, // 58: azpb.Checker.TenantCreateGroup:input_type -> azpb.TenantCreateGroupRequest
	26, // 59: azpb.Checker.GroupList:input_type -> azpb.GroupListRequest
	24, // 60: azpb.Checker.Group:input_type -> azpb.GroupRequest
	24, // 61: azpb.Checker.GroupPermissions:input_type -> azpb.GroupRequest
	25, // 62: azpb.Checker.GroupSave:input_type -> azpb.GroupSaveRequest
	27, // 63: azpb.Checker.GroupAddPermission:input_type -> azpb.GroupModifyPermissionRequest
	27, // 64: azpb.Checker.GroupRemovePermission:input_type -> azpb.GroupModifyPermissionRequest
	32, // 65: azpb.Checker.GroupSetTenant:input_type -> azpb.GroupSetTenantRequest
	36, // 66: azpb.Checker.FeedList:input_type -> azpb.FeedListRequest
	35, // 67: azpb.Checker.Feed:input_type -> azpb.FeedRequest
	35, // 68: azpb.Checker.FeedPermissions:input_type -> azpb.FeedRequest
	40, // 69: azpb.Checker.FeedSetGroup:input_type -> azpb.FeedSetGroupRequest
	43, // 70: azpb.Checker.FeedVersionList:input_type -> azpb.FeedVersionListRequest
	45, // 71: azpb.Checker.FeedVersion:input_type -> azpb.FeedVersionRequest
	45, // 72: azpb.Checker.FeedVersionPermissions:input_type -> azpb.FeedVersionRequest
	48, // 73: azpb.Checker.FeedVersionAddPermission:input_type -> azpb.FeedVersionModifyPermissionRequest
	48, // 74: azpb.Checker.FeedVersionRemovePermission:input_type -> azpb.FeedVersionModifyPermissionRequest
	7,  // 75: azpb.Checker.UserList:output_type -> azpb.UserListResponse
	8,  // 76: azpb.Checker.User:output_type -> azpb.UserResponse
	10, // 77: azpb.Checker.Me:output_type -> azpb.MeResponse
	16, // 78: azpb.Checker.TenantList:output_type -> azpb.TenantListResponse
	15, // 79: azpb.Checker.Tenant:output_type -> azpb.TenantResponse
	17, // 80: azpb.Checker.TenantPermissions:output_type -> azpb.TenantPermissionsResponse
	22, // 81: azpb.Checker.TenantSave:output_type -> azpb.TenantSaveResponse
	22, // 82: azpb.Checker.TenantAddPermission:output_type -> azpb.TenantSaveResponse
	22, // 83: azpb.Checker.TenantRemovePermission:output_type -> azpb.TenantSaveResponse
	22, // 84: azpb.Checker.TenantCreate:output_type -> azpb.TenantSaveResponse
	31, // 85: azpb.Checker.TenantCreateGroup:output_type -> azpb.GroupSaveResponse
	29, // 86: azpb.Checker.GroupList:output_type -> azpb.GroupListResponse
	28, // 87: azpb.Checker.Group:output_type -> azpb.GroupResponse
	30, // 88: azpb.Checker.GroupPermissions:output_type -> azpb.GroupPermissionsResponse
	31, // 89: azpb.Checker.GroupSave:output_type -> azpb.GroupSaveResponse
	31, // 90: azpb.Checker.GroupAddPermission:output_type -> azpb.GroupSaveResponse
	31, // 91: azpb.Checker.GroupRemovePermission:output_type -> azpb.GroupSaveResponse
	33, // 92: azpb.Checker.GroupSetTenant:output_type -> azpb.GroupSetTenantResponse
	39, // 93: azpb.Checker.FeedList:output_type -> azpb.FeedListResponse
	38, // 94: azpb.Checker.Feed:output_type -> azpb.FeedResponse
	37, // 95: azpb.Checker.FeedPermissions:output_type -> azpb.FeedPermissionsResponse
	41, // 96: azpb.Checker.FeedSetGroup:output_type -> azpb.FeedSaveResponse
	46, // 97: azpb.Checker.FeedVersionList:output_type -> azpb.FeedVersionListResponse
	44, // 98: azpb.Checker.FeedVersion:output_type -> azpb.FeedVersionResponse
	47, // 99: azpb.Checker.FeedVersionPermissions:output_type -> azpb.FeedVersionPermissionsResponse
	49, // 100: azpb.Checker.FeedVersionAddPermission:output_type -> azpb.FeedVersionSaveResponse
	49, // 101: azpb.Checker.FeedVersionRemovePermission:output_type -> azpb.FeedVersionSaveResponse
